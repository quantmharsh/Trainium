          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            <div className="lg:col-span-7 space-y-8 relative">
              ...
              <div className="flex items-center gap-10 py-6 font-mono">
                ...
                <div className="flex flex-col">
                  <div className="text-2xl text-primary"><CountUp start={40} end={3} duration={2} separator="," />min</div>
                  <div className="text-xs uppercase tracking-wider">GENERATION</div>
                </div>
                <div className="h-12 w-px bg-gradient-to-b from-transparent via-border to-transparent"></div>
                <div className="flex flex-col">
                  <div className="text-2xl text-primary"> <CountUp start={10} end={100} duration={2} separator="," />%</div>
